...
public class RichBottomNavigationView extends BottomNavigationView {
    ...
    private int mWidth;
    private int mHeight;
    private int mShadowElevation = 0; //changed from 8 to 0 (temir)
    ...
    private void init() {
        ...
        //setShadowVisible(true); //I don't need shadow (temir)
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mWidth = w;
        mHeight = h;
        //updateShadowBounds(); // i don't need it (temir)
    }
